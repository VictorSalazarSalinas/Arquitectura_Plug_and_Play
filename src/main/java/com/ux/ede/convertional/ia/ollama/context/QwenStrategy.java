...
public class QwenStrategy implements InteligenciaArtificialStrategy {
    ...
    private static final Logger LOGGER = Logger.getLogger(QwenStrategy.class.getName());
    ...
    public String generarRespuesta(PromptConfig config) {
        ...
        LOGGER.log(Level.SEVERE, "[LOG Strategy] Respuesta inesperada del motor IA (Qwen 2.5): {0}", jsonRespuesta);
